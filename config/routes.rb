...
#      user_user_profiles POST   /users/:user_id/user_profiles(.:format)      user_profiles#create
#  new_user_user_profiles GET    /users/:user_id/user_profiles/new(.:format)  user_profiles#new
# edit_user_user_profiles GET    /users/:user_id/user_profiles/edit(.:format) user_profiles#edit
#                         GET    /users/:user_id/user_profiles(.:format)      user_profiles#show
#                         PATCH  /users/:user_id/user_profiles(.:format)      user_profiles#update
#                         PUT    /users/:user_id/user_profiles(.:format)      user_profiles#update
#                         DELETE /users/:user_id/user_profiles(.:format)      user_profiles#destroy
